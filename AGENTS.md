...
- **Master menu** (`/masters` → `Masters/Menu.vue`) = landing card grid semua entity (Factory/Departemen/Jenis/Merk/Kapasitas/Limit/Spesifikasi + Alat Ukur). Route list: `masters.menu`, `masters.index`.
